defmodule Recollect.Maintenance.ReembedTest do
  use Recollect.DataCase, async: false

  alias Recollect.Maintenance.Reembed
  ...
  describe "run/1 with custom embedding_fn" do
    ...
    test "invokes progress_callback per batch" do
      ...
      assert_received {:progress, %{table: "recollect_entries", processed: _, total: _}}
    end
  end
end
