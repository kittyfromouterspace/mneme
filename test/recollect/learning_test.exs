defmodule Recollect.LearningTest do
  use Recollect.DataCase, async: false

  alias Recollect.Learner.Git
  alias Recollect.Learning.Pipeline

  describe "Recollect.Learner (behaviour)" do
    test "Git learner has correct source" do
      assert Git.source() == :git
    end
  end

  describe "Recollect.Learner.Git.extract/1" do
  ...
  describe "Recollect.Learner.Git.detect_patterns/1" do
  ...
  describe "Recollect.Learning.Pipeline" do
