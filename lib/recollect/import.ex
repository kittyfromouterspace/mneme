defmodule Recollect.Import do
  ...
  defp get_required_fields(:recollect_entries), do: [:id, :content]
  defp get_required_fields(:recollect_chunks), do: [:id, :content, :document_id]
  defp get_required_fields(:recollect_entities), do: [:id, :name, :entity_type]
  defp get_required_fields(:recollect_documents), do: [:id, :content, :collection_id]
  defp get_required_fields(:recollect_collections), do: [:id, :name]
  defp get_required_fields(:recollect_relations), do: [:id, :relation_type, :from_entity_id, :to_entity_id]
  defp get_required_fields(:recollect_edges), do: [:id, :relation, :source_entry_id, :target_entry_id]
  defp get_required_fields(:recollect_pipeline_runs), do: [:id, :document_id]
