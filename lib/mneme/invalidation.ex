defmodule Mneme.Invalidation do
  ...
  ## Usage
      ...
      # Manual invalidation
      Mneme.Invalidation.invalidate(scope_id, "webpack",
  ...
  def run_from_git(opts \\ []) do
    ...
    Telemetry.event([:mneme, :invalidation, :start], %{scope_id: scope_id}, %{days: days})
