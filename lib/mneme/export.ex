defmodule Mneme.Export do
  @moduledoc """
  Export Mneme data to a portable format for migration or backup.

  Supports exporting all Mneme tables to JSONL format, which can then be
  imported into any supported database backend (PostgreSQL or libSQL).

  ## Usage

      # Export all data
      Mneme.Export.export_all("/path/to/backup.jsonl")

      # Export specific tables
      Mneme.Export.export_table(:mneme_entries, "/path/to/entries.jsonl")
  ...
  Example:
      {"table": "mneme_entries", "version": "0.2.0", "data": {"id": "...", "content": "..."}}
      {"table": "mneme_chunks", "version": "0.2.0", "data": {"id": "...", "content": "..."}}
  """
  ...
  @doc """
  Export all Mneme tables to a JSONL file.
  ...
  ## Example
      ...
      Mneme.Export.export_all("/tmp/mneme_backup.jsonl")
  ...
  ## Example
      ...
      Mneme.Export.export_table(:mneme_entries, "/tmp/entries.jsonl")
  """
