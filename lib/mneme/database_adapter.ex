defmodule Mneme.DatabaseAdapter do
  ...
  Mneme supports multiple database backends through this adapter pattern.
  Currently supported:
  ...
  The adapter is used internally by Mneme to generate database-specific
  ...
  ## Examples
      ...
      iex> adapter.vector_index_sql(:mneme_entries, :embedding, dimensions: 768)
